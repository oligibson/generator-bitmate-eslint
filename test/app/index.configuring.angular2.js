...
test('Configuring package.json: angular2/webpack/babel', t => {
  Utils.call(context, 'configuring.pkg', {client: 'angular2', modules: 'webpack', js: 'babel'});
...
test('Configuring package.json: angular2/webpack/js', t => {
  Utils.call(context, 'configuring.pkg', {client: 'angular2', modules: 'webpack', js: 'js'});
...
test('Configuring package.json: angular2/webpack/typescript', t => {
  Utils.call(context, 'configuring.pkg', {client: 'angular2', modules: 'webpack', js: 'typescript'});
...
test('Configuring package.json: angular2/systemjs/typescript', t => {
  Utils.call(context, 'configuring.pkg', {client: 'angular2', modules: 'systemjs', js: 'typescript'});
